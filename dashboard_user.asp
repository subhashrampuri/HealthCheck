...
<body leftmargin="0" topmargin="0" marginheight="0" marginwidth="0" bgcolor="#ffffff">
                      ...
                      <td valign="top"  colspan="3">
                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                          ...
                          <tr> 
                            <td valign="top" width="5%">&nbsp;</td>
                            <td valign="top"> 
                              <form name="frmDashboard" method="post" action="dashboard_user.asp" onSubmit="return Validate_Form();">
								...
								'  	sLocAttach = "Select loc_ShortCode,loc_Name from tblLocations order by loc_ShortCode"
									...
									While Not RsLoc.EOF
									  	sAttach = "Select tdm_UploadDocument from tblTransactionDetailsMaster where tdm_UploadDocument is not null and  loc_ShortCode='"& RsLoc("loc_ShortCode") &"' " & _
											" and datediff(dd,'"& tFilterDate &"',tdm_Date)=0 and usr_EmpID = '"& Trim(Emp_ID)&"'  and act_Time = '"& tSlot &"' "
							  ...
							  %>
                                <tr class="Content" valign="top"> 
                                  ...
                                  <%
									...
									sDash = "select chkpnt_ID from tblTransaction where usr_EmpID = '"&Trim(Emp_ID)&"' and loc_Shortcode ='"& adoLoc("loc_ShortCode")&"' and chkpnt_ID = "& objRs("chkpnt_ID") &" "
 								    Set adoRs = ConnFMG.Execute(sDash)
										...
										sMatrixData = "SELECT tblTransactionDetails.tdt_Comments, tblTransactionDetailsMaster.tdm_UploadDocument,tblTransactionDetails.tdt_Date, "& _
											...
											" tblTransactionDetails.tdm_ID = tblTransactionDetailsMaster.tdm_ID Where tblTransactionDetails.usr_EmpID = '"&Trim(Emp_ID)&"' " & _
  ...
  <input type="hidden" name="hdLocation" value="<%=Trim(Loc_ID)%>">  
