                      ...
                      <td valign="top"  colspan="3">
                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                          ...
                          <tr>
                            <td valign="top" width="5%">&nbsp;</td>
                            <td valign="top">
                              <form name="frmDashboard" method="post" action="dashboard_user_all.asp" onSubmit="return Validate_Form();">
						...
						'		Response.end
						  ...
						  %>
                              <table width="100%" border="0" bordercolor="#FFFFFF" cellspacing="1" cellpadding="3" bgcolor="#FFFFFF">
                                <tr>
							...
							%>
                                <tr class="Content" valign="middle" >
                                  ...
                                  <%
								  	...
								  	sLocation = "Select loc_ShortCode,loc_Name from tblLocations where Isactive = 1 order by loc_ShortCode "
									objLoc.Open sLocation,ConnFMG,3,3
									While Not objLoc.EOF
									locCode = Left(objLoc("loc_ShortCode"),4)
								  %>
                                  <td bgcolor="#9FC4E1" align="center"><b><%=Left(objLoc("loc_ShortCode"),4)%></b></td>
                                  <%
								  	objLoc.MoveNext
								  	Wend
								  	objLoc.Close
                                ...
                                <tr class="Content" valign="top">
								  ...
								  <%
								  	...
								  	sLocAttach = "Select loc_ShortCode,loc_Name from tblLocations where Isactive = 1  order by loc_ShortCode"
							  ...
							  %>
                                <tr class="Content" valign="top">
                                  ...
                                  <%
									...
									sLocation = "dashboard_getLocation"
									adoLoc.Open sLocation,ConnFMG,3,3
									While Not adoLoc.EOF

									sDash = "dashboard_transaction '"& adoLoc("loc_ShortCode")&"',"& objRs("chkpnt_ID") &" "
									Set adoRs = ConnFMG.Execute(sDash)
									if Not adoRs.EOF then
						

										 sMatrixData = "dashboard_all("&chk_pnt_ID&",'"& tFilterDate &"','"& tSlot &"','"& adoLoc("loc_ShortCode")&"')"	
